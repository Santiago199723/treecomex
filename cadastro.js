const config = {
  ...
  let contactFormDB = firebase.database().ref("cadastro-orion-global");
  ...
  document
    ...
    .addEventListener("submit", function (event) {
      ...
      let estadoValue = getElementVal("CodUf");
      let estadoSigla = estadosSiglas[estadoValue];
  
      saveInDatabase(uid, nome, empresa, cpf, cnpj, tipo, estadoSigla);
  ...
  const saveInDatabase = (uid, nome, empresa, cpf, cnpj, tipo, estado) => {
